...
internal class IdentityServerTests
{
    private static readonly string _authority = "http://localhost:53414";
    private static OidcClient _oidcClient;
    private static readonly HttpClient _httpClient = new() { BaseAddress = new Uri(_authority) };
    ...
    private static async Task Login()
    {
        ...
        options.LoggerFactory.AddSerilog(serviceProvider.GetService<ILogger>());
